...
const mockData = [
  { 
    id: 1, 
    src: '/images/câu 1.1.jpg', 
    alt: 'Đồ vật 1' 
  },
  { 
    id: 2, 
    src: '/images/câu 1.2.jpg', 
    alt: 'Đồ vật 2' 
  },
  { 
    id: 3, 
    src: '/images/câu 1.3.jpg', 
    alt: 'Đồ vật 3' 
  },
  { 
    id: 4, 
    src: '/images/câu 1.4.jpg', 
    alt: 'Đồ vật 4' 
  },
  { 
    id: 5, 
    src: '/images/câu 1.5.jpg', 
    alt: 'Đồ vật 5' 
  },
  { 
    id: 6, 
    src: '/images/câu 1.6.jpg', 
    alt: 'Đồ vật 6' 
  },
];
      ...
      <div className="max-w-2xl mx-auto">
        <Card className="p-6 space-y-6">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            Bạn hãy chọn những hoạt động đã được trải nghiệm trong Chương trình “Vui xuân Ất Tỵ: Sắc thái Văn hoá Mường, Hoà Bình” của Bảo tàng DTHVN?
            </h1>
          </div>
