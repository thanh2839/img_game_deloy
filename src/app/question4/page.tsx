      ...
      <div className="max-w-2xl mx-auto">
        <Card className="p-6 space-y-6">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            Trong các hoạt động khám phá di sản văn hoá qua công nghệ tại toà Trống đồng, toà Cánh diều, Vườn Kiến trúc, bạn đã trải nghiệm chơi những trò chơi công nghệ nào?
            </h1>
          </div>
