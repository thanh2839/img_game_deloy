...
const mockData = [
  { 
    id: 1, 
    src: '/images/câu 3.1.jpg', 
    alt: 'Đồ vật 1' 
  },
  { 
    id: 2, 
    src: '/images/câu 3.2.jpg', 
    alt: 'Đồ vật 2' 
  },
  { 
    id: 3, 
    src: '/images/câu 3.3.jpg', 
    alt: 'Đồ vật 3' 
  },
  { 
    id: 4, 
    src: '/images/câu 3.4.jpg', 
    alt: 'Đồ vật 4' 
  },
  { 
    id: 5, 
    src: '/images/câu 3.5.jpg', 
    alt: 'Đồ vật 5' 
  },
  { 
    id: 6, 
    src: '/images/câu 3.6.jpg', 
    alt: 'Đồ vật 6' 
  },
];
      ...
      <div className="max-w-2xl mx-auto">
        <Card className="p-6 space-y-6">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            Trong khu vực trải nghiệm văn hóa Tết ở tầng 1, Tòa Cánh diều và Phòng khám phá, bạn đã tham gia trải nghiệm nào trong các bức ảnh dưới đây?
            </h1>
          </div>
